    ...
    <div class="col-md-12">
        ...
        <?php if($_GET["success"] == "true") { ?>
            <div class="alert alert-success alert-dismissable" role="alert">
                ...
                <strong>Gelukt.</strong> De vragenlijst is succesvol opgeslagen.
            </div>
        ...
        <?php if($_GET["deleted"] == "true"): ?>
            <div class="alert alert-success alert-dismissable" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Sluiten"><span aria-hidden="true">&times;</span></button>
                <strong>Gelukt.</strong> De vragenlijst is succesvol verwijderd.
            </div>
        <?php endif; ?>
...
<div class="row">
    ...
    <div class="col-md-9">
        ...
        <a class="btn btn-primary pull-right" href="new/"><i class="glyphicon glyphicon-plus"></i> Nieuwe vragenlijst</a>
        <?php echo $table;?>
    </div>
</div>
